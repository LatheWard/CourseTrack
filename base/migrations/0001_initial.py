    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('students', models.ManyToManyField(blank=True, null=True, related_name='courses_completed', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='UserGrade',
            fields=[
                ...
                ('numGrade', models.PositiveIntegerField(validators=[django.core.validators.MaxValueValidator(100)])),
